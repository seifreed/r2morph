...
_CURRENT_ANGR_LOCAL_REPORT = "protection-adversarial-angr-local-2026-09-18-59898697.json"
...
def _review_vm_semantic_gap_scope(root: Path) -> dict[str, object]:
    ...
    return _check(
        ...
        passed,
        "memory/calls/ABI/unwind/TLS/thread/FP/SSA-liveness campaign evidence is complete",
    )
