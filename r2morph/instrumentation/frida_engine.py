...
class FridaEngine:
    ...
    def instrument_binary(
        ...
        try:
            ...
            result.anti_analysis_detected = [event["type"] for event in self.anti_analysis_events]
    ...
    def get_runtime_statistics(self) -> dict[str, Any]:
        ...
        return {
            **self.stats,
            ...
            "unique_apis_called": len(set(call.get("function", "") for call in self.api_calls)),
        }
