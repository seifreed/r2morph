...
from r2morph.mutations.code_virtualization_region_fp_decoders import (
    ...
    _decode_fp_riprel,
    _decode_fp_vex_128_permute_immediate,
...
def _classify_vector(text: str, address: int, size: int) -> list[Any] | None:
    return _first_item(
        (
            ...
            lambda: _decode_fp_vex_scalar_fma(text),
            lambda: _decode_fp_vex_scalar_fma_mem(text, address, size),
            ...
            lambda: _decode_fp_vex_packed_immediate_mem(text, address, size),
            lambda: _decode_fp_vex_packed_mem(text, address, size),
            lambda: _decode_fp_vex_128_permute_immediate(text),
            lambda: _decode_fp_legacy_packed_shuffle_immediate(text),
            lambda: _decode_fp_vex_packed_compare_mem(text, address, size),
            lambda: _decode_fp_vex_packed_compare(text),
            lambda: _decode_fp_vex_256_variable_blend(text),
            lambda: _decode_fp_vex_256_variable_permute(text),
            lambda: _decode_fp_vex_256_permute_immediate(text),
            lambda: _decode_fp_vex_256_lane_permute_immediate(text),
            lambda: _decode_fp_vex_fma(text),
            lambda: _decode_fp_vex_fma_mem(text, address, size),
            lambda: _decode_fp_vex_packed_arith_mem(text, address, size),
            lambda: _decode_fp_vex_256_packed_arith(text),
            lambda: _decode_fp_vex_256_fma_mem(text, address, size),
            ...
            lambda: _decode_fp_compare_riprel(text, address, size),
            ...
            lambda: _decode_fp_packed_arith_extra(text),
            lambda: _decode_fp_packed_arith_extra_mem(text),
            lambda: _decode_fp_packed_arith_extra_riprel(text, address, size),
            lambda: _decode_fp_packed_arith_extra_idx(text),
