...
_FIXED_SIZE_GROUPS = {
    1: ("vbinop", "vbinopsynth", "vcmpsynth", "fsave", "frestore", "vzeroupper", "vzeroall", "syscall"),
    2: (
        "vpush",
        "vpop",
        "vpop8",
    ...
    4: ("div", "fppackedvex", "fppackedvex256", "fppackedveximm", "fppackedvex256imm"),
    5: ("rspadj", "jmp", "jcc", "vcall", "call", "fppackedvex256permimm"),
    6: (
        "vloadrip",
        "vstorerip",
        "vlearip",
