...
def handler_instances_asm(
    ...
    *,
    ...
    for index in emit_order:
        ...
        elif handler_key.startswith("vshiftreg_"):
            lines.append(_vshiftreg_handler_asm(handler_key, key))
        ...
        elif handler_key.startswith("bswap_"):
            lines.append(_bswap_handler_asm(handler_key, key))
        elif handler_key.startswith("div_"):
