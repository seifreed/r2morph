...
High-level Rich-console renderers composed for CLI report sections. The
low-level section/table helpers live in report_rendering_sections; this module
depends on them one-way (never the reverse).
"""
