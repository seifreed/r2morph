...
def create_symbolic_state(
    ...
    try:
        ...
        stack_reg = "rsp" if bits == _BITS_64 else "esp"
        base_reg = "rbp" if bits == _BITS_64 else "ebp"
        ...
        for reg in observables:
            ...
            if hasattr(state.regs, reg):
                size = _BITS_64 if reg.startswith("r") or reg.startswith("e") else _BITS_32
