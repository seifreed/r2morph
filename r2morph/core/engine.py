...
def _build_gate_failure_priority(gate_failures: dict[str, Any] | None) -> list[dict[str, Any]]:
...
def _build_gate_failure_severity_priority(
...
class MorphEngine:
    ...
    def build_report(self, result: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        return {
            ...
            "symbolic_issue_map": symbolic_issue_map,
            "symbolic_coverage_map": symbolic_coverage_map,
