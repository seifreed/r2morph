...
class RegTracker:
    ...
    X86_64_GPR: ClassVar[dict[str, tuple[str, str, str | None, str]]] = {
        "rax": ("eax", "ax", "ah", "al"),
        "rbx": ("ebx", "bx", "bh", "bl"),
        "rcx": ("ecx", "cx", "ch", "cl"),
        "rdx": ("edx", "dx", "dh", "dl"),
    ...
    X86_64_REG_SIZES: ClassVar[dict[int, list[str]]] = {
    ...
    REG_WEIGHTS: ClassVar[dict[str, tuple[int, tuple[int, int, int, int]]]] = {
        "rax": (30, (10, 5, 2, 1)),
        "rbx": (20, (8, 4, 2, 1)),
        "rcx": (25, (10, 5, 2, 1)),
        "rdx": (25, (10, 5, 2, 1)),
    ...
    PRESERVED_REGS: ClassVar[list[str]] = ["rbx", "rbp", "r12", "r13", "r14", "r15"]
    SCRATCH_REGS: ClassVar[list[str]] = ["rax", "rcx", "rdx", "rsi", "rdi", "r8", "r9", "r10", "r11"]
    ...
    def get_subregisters(self, reg: str) -> tuple[str, str, str | None, str] | None:
