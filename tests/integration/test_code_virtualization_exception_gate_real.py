"""Regression coverage for closed exception and unwinding rejection."""
...
def test_code_virtualization_rejects_real_unwind_metadata_before_transform(tmp_path: Path) -> None:
    """A real C++ executable with unwind sections is left untouched."""
...
int main() { return protected_function(-1); }
""")
