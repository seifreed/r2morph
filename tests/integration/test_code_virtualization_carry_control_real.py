"""Real-ELF regression coverage for virtual carry-control instructions."""
...
def test_virtualized_carry_control_preserves_real_elf_result(tmp_path: Path) -> None:
    original = _compile_elf_x86_64_binary(tmp_path, "carry_control", _SOURCE)
    mutated = tmp_path / "carry_control_mutated"
