...
def test_vex128_horizontal_fixture_virtualization_preserves_result(tmp_path: Path) -> None:
    ...
    with Binary(mutated, writable=True) as binary:
        ...
        binary.save()
    expect(stats["functions_virtualized"] == 1, "horizontal fixture function was not virtualized")
...
def test_vex128_horizontal_fixture_emulator_preserves_result() -> None:
    expect(emulate_exit_code(_FIXTURE) == _EXPECTED_EXIT_CODE, "horizontal VEX emulator result diverged")
