...
def test_symbolic_issue_and_coverage_reducers() -> None:
    ...
    expect(
        _summarize_symbolic_issue_passes(mutations)
        == [
            {
                "pass_name": "nop",
                "severity": "mismatch",
    ...
    expect(
        _summarize_symbolic_coverage_by_pass(mutations)
        == [
            {
                "pass_name": "nop",
...
def test_symbolic_summary_and_overview_reducers() -> None:
    ...
    expect(
        _summarize_symbolic_severity_by_pass({"nop": {"symbolic_summary": summary}})
