...
class _ArchitectureBinary:
    ...
    def __init__(self, binary_format: str, architecture: str) -> None:
        self._arch_info = {"format": binary_format, "arch": architecture}
