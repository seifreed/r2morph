...
REPORTING_MODULES = [
    ...
    "r2morph.reporting.report_rendering_pass_section_helpers",
    ...
    "r2morph.reporting.summary_aggregator_evidence_rows",
    ...
    "r2morph.core.report_helpers_coverage",
    "r2morph.core.report_helpers_region_evidence",
    ...
    "r2morph.core.parallel_executor_task_policies",
    ...
    "r2morph.core.parallel_work_queue_helpers",
    ...
    "r2morph.core.analysis_cache_lifecycle",
    "r2morph.core.analysis_cache_queries",
    ...
    "r2morph.analysis.enhanced_analyzer_detection",
    "r2morph.analysis.enhanced_analyzer_phases",
    ...
    "r2morph.analysis.switch_table_resolution",
    ...
    "r2morph.validation.differ_comparison",
    ...
    "r2morph.validation.extended_semantic_validation",
    "r2morph.analysis.symbolic.constraint_solver_parsing",
    "r2morph.analysis.symbolic.constraint_solver_conversions",
    "r2morph.analysis.symbolic.constraint_solver_analysis",
    "r2morph.analysis.symbolic.path_explorer_models",
    "r2morph.analysis.symbolic.path_explorer_results",
    ...
    "r2morph.analysis.symbolic.syntia_equivalence",
    ...
    "r2morph.devirtualization.binary_rewriter_io",
