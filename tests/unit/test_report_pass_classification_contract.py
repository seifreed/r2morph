...
def test_pass_classification_predicates_cover_risk_and_clean_variants() -> None:
    ...
    expect(_is_risky_pass(risky_evidence, None))
    expect(_is_risky_pass(None, risky_symbolic))
    expect(_has_structural_risk(risky_evidence, None))
    expect(_has_symbolic_risk(None, risky_symbolic))
    expect(_is_clean_pass(clean_evidence, clean_symbolic))
    expect(_is_covered_pass(covered_evidence, clean_symbolic))
    expect(_is_uncovered_pass(clean_evidence, uncovered_symbolic))
