...
def test_build_region_report_includes_expected_fields() -> None:
    ...
    expect(
        ...
        == {
            "start_address": 4096,
            "end_address": 4099,
            "original_loaded_address": 8192,
            "mutated_loaded_address": 12288,
            "step_budget": 7,
            "region_exit_budget": 14,
            "step_strategy": "region-exit",
            "original_region_exit_steps": 2,
            "mutated_region_exit_steps": 3,
            "original_trace_addresses": [16384],
            "mutated_trace_addresses": [20480],
...
def test_build_binary_comparison_result_handles_empty_regions() -> None:
    ...
    expect(
        ...
        == {
            ...
            "symbolic_binary_paths": {"original": "/prev.bin", "mutated": "/curr.bin"},
        }
    )
