...
def test_vm_eh_frame_deduplicates_identical_call_cfa_rows() -> None:
    metadata = build_vm_eh_frame(
        0x500000,
        0x180,
        0x400,
        0x510000,
        ((0x20, 0x28, 0x123), (0x20, 0x28, 0x123)),
    )
...
def test_vm_eh_frame_round_trips_remapped_lsda_call_site() -> None:
    metadata = build_vm_eh_frame_with_lsda(
        VmEhFrameSpec(
            ...
            ((0x20, 0x28, 0x123),),
            (0xFF, 0x03, 17, 8, bytes((0x01, 0x00, 0x11, 0x22, 0x33, 0x44)), 0x01, 2),
            (
