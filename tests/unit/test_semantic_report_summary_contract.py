...
def test_build_semantic_report_summary_counts_results_and_violations() -> None:
    results = [
        SimpleNamespace(
            ...
            region=SimpleNamespace(**{MUTATION_NAME_KEY: "nop"}),
        ),
        SimpleNamespace(
        ...
        SimpleNamespace(
            ...
            region=SimpleNamespace(**{MUTATION_NAME_KEY: "flatten"}),
        ),
        SimpleNamespace(
    ...
    expect(
        build_semantic_report_summary(results)
        == {
            "total_mutations": 4,
            "passed": 1,
            "failed": 1,
