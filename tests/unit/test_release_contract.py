...
def test_compatibility_corpus_documents_current_generated_variant_count() -> None:
    ...
    expect(
        "same 136 generated ELF x86-64 variants" in contract
        and "all 136 generated variants" in contract
...
def test_corpus_workflows_run_the_full_pass_selection() -> None:
    ...
    expect(
        ...
        and "always() && (github.event_name != 'workflow_run'" in adversarial
...
def test_adversarial_workflow_covers_nine_vm_resistance_shapes() -> None:
    ...
    expect(
        'report["fixture_count"] != 9' in workflow
        and all(
