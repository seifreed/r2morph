...
- RB-003: VM semantics remain incomplete for memory, calls, ABI, unwinding, TLS/signals,
  threads, FP/SIMD, and SSA/liveness. The scheduled campaign now covers 311 fixtures
  per seed across three deterministic seeds (933 fixture runs: 453 repository-fixture
  executions and 480 generated-corpus executions), including ordinary unwind metadata
