...
| Instruction substitution | Tier 1 | Linux ELF x86-64; Mach-O AArch64 preview | Rule coverage is ISA-specific; preview evidence covers only direct 12-bit move-immediate substitutions | `tests/product_smoke`, `tests/integration`, `tests/integration/test_mutation_nop_insertion_arm64.py` |
