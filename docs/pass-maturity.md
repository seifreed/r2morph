...
differential campaign: 172 additional Linux ELF x86-64 fixtures. The scheduled
campaign repeats the combined 323-fixture set across three deterministic seeds,
for 969 fixture runs (453 repository fixtures and 516 generated-corpus runs),
...
The scheduled Linux CI contract requires all 969 pairs to complete with no
...
target; it predates the current scheduled inventory of 323 fixtures per seed
(151 repository fixtures and 172 generated variants).
