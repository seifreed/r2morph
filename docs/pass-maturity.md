...
string-obfuscation-instruction-catalogued profile pass, and 9
...
composition support, and 9 without an exhaustive affected-instruction
catalogue: 57 total per-pass maturity field gaps across 5 maturity gap
