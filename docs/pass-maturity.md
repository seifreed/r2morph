...
string-obfuscation-instruction-catalogued profile pass, and 4
...
composition support, and 4 without an exhaustive affected-instruction
catalogue: 52 total per-pass maturity field gaps across 5 maturity gap
