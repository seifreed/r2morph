...
decompiler-effectiveness text by profile so unmeasured risk and analyzer
effectiveness remain visible release gaps instead of being buried in each pass
row.
