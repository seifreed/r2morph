...
also runs one native ELF ARM32 and one native ELF x86 32-bit
instruction-substitution smoke case; they are preview evidence only and do not
close the per-pass ARM or x86 parity gaps.
