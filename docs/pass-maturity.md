...
| Instruction substitution | Tier 1 | Linux ELF x86-64; ELF ARM32, x86-32, AArch64, PE x86-64, and Mach-O AArch64 preview | Rule coverage is ISA-specific; preview evidence is limited to focused real fixtures and does not imply format parity | `tests/product_smoke`, `tests/integration`, `tests/integration/test_mutation_nop_insertion_arm64.py`, `tests/integration/test_nop_insertion_pe_real.py`, `tests/integration/test_elf_arm32_native.py`, `tests/integration/test_elf_arm64_native.py`, `tests/integration/test_elf_x86_32_native.py` |
| Register substitution | Tier 1 | Linux ELF x86-64; ELF ARM32, x86-32, AArch64, PE x86-64, and Mach-O AArch64 preview | Requires proven liveness and ABI preservation; preview evidence is limited to focused real fixtures | `tests/product_smoke`, `tests/integration`, `tests/integration/test_nop_insertion_pe_real.py`, `tests/integration/test_mutation_register_substitution_arm64.py`, `tests/integration/test_elf_arm32_native.py`, `tests/integration/test_elf_arm64_native.py`, `tests/integration/test_elf_x86_32_native.py` |
| Instruction expansion | Experimental | Linux ELF x86-64; ELF ARM32, x86-32, AArch64, PE x86-64, and Mach-O AArch64 preview | Selected by the compatibility corpus and current composition smoke; preview evidence is limited to focused real fixtures and analyzer-effectiveness results remain incomplete | `README.md`, `docs/compatibility-corpus.md`, `tests/integration/test_mutation_nop_insertion_arm64.py`, `tests/integration/test_nop_insertion_pe_real.py`, `tests/integration/test_elf_arm32_native.py`, `tests/integration/test_elf_arm64_native.py`, `tests/integration/test_elf_x86_32_native.py` |
...
| Code virtualization | Experimental | ELF x86-64 | Selected by the compatibility corpus and current composition smoke; unsupported functions are rejected or conservatively unchanged with diagnostics; indexed memory-indirect calls have a native regression | `docs/protection-maturity.md`, `docs/compatibility-corpus.md`, `tests/integration/test_code_virtualization_generic_isa_real.py`, `tests/integration/test_code_virtualization_internal_icall_real.py` |
...
| Constant unfolding | Experimental | ELF x86-64; ELF ARM32, x86-32, AArch64, PE x86-64, and Mach-O AArch64 preview | Selected by the compatibility corpus; x86 add/sub rules and analyzer-effectiveness evidence remain incomplete; non-official evidence covers focused real fixtures only | `tests/integration/test_protection_maturity_baseline.py`, `tests/integration/test_nop_insertion_pe_real.py`, `tests/integration/test_mutation_nop_insertion_arm64.py`, `tests/integration/test_elf_arm32_native.py`, `tests/integration/test_elf_arm64_native.py`, `tests/integration/test_elf_x86_32_native.py`, `fixtures/dataset/elf_constant_unfold_x86_64.S`, `docs/compatibility-corpus.md` |
...
current matrix records 100.0% official evidence, 10.74% non-official evidence,
26 non-official evidenced cells, and 216 non-official not-supported cells. It
...
AArch64/ARM/x86 remain at 0.0% evidence. The generated
...
differential campaign: 184 additional Linux ELF x86-64 fixtures. The scheduled
campaign repeats the combined 335-fixture set across three deterministic seeds,
for 1005 fixture runs (453 repository fixtures and 552 generated-corpus runs),
...
The scheduled Linux CI contract requires all 1005 pairs to complete with no
...
target; it predates the current scheduled inventory of 335 fixtures per seed
(151 repository fixtures and 184 generated variants).
